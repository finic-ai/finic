...
const ApiKeysForm: React.FC<SubdomainMetadataFormProps> = ({onSubmit, emailRequired, appName, loading}) => {
    ...
    return(
        <div>
            ...
            <Button disabled={!( (!emailRequired || email) && apiKey)} size="xl" className="mb-6 mt-4 w-3/5 min-w-300 text-white bg-blue-600 hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed" onClick={() => 
