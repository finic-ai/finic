...
const SubdomainMetadataForm: React.FC<SubdomainMetadataFormProps> = ({onSubmit}) => {
    ...
    return(
        <div>
            ...
            <div className="flex justify-center">
            <Button disabled={!subdomain} size="xl" className="mb-6 mt-4 w-3/5 min-w-300 text-white bg-blue-600 hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed" onClick={() => 
                onSubmit(subdomain)} >
                Set subdomain
            </Button>
            </div>
