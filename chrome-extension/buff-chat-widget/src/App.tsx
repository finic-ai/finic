...
function App() {
  ...
  return (
    <ChakraProvider theme={theme}>
      <Container margin='40px 0' display='flex' justifyContent='center' position='fixed' right='40px' bottom='55px' zIndex={9999} boxShadow='5px 5px 13px rgba(91, 81, 81, 0.4)' borderRadius='5px'>
        {chatOpen ? 
          <Chatbot 
          config={config}
