...
const App: React.FC = () => {
  ...
  const renderAppStep = () => {
    switch (currentStep) {
      ...
      case 1:
        return <ConnectorPage customerName={customerName} customerLogoUrl={customerLogoUrl} setCurrentStep={setCurrentStep} setConnectorName={setConnectorName}/>
      case 2:
        return <ResultPage customerName={customerName} customerLogoUrl={customerLogoUrl} setCurrentStep={setCurrentStep} connectorName={connectorName}/>
      default:
        return <StartPage customerName={customerName} customerLogoUrl={customerLogoUrl} setCurrentStep={setCurrentStep}/>
    }
  }
