...
/*
 * Documentation:
 * Email Row — https://app.subframe.com/library?component=Email+Row_409e2e8c-9725-4f71-82d5-3bfa3dc3bdef
...
const EmailRowRoot = React.forwardRef<HTMLElement, EmailRowRootProps>(
  function EmailRowRoot(
    ...
    return (
      ...
      >
        {name ? (
          <span className="line-clamp-1 w-full max-w-[240px] grow shrink-0 basis-0 text-body-bold font-body-bold text-default-font">
            {name}
          </span>
        ) : null}
        {emailPreview ? (
