...
export default function GenerativeAINode(props: NodeProps<GenerativeAINode>) {
...
export function GenerativeAINodeConfigurationDrawer({}: GenerativeAINodeConfigurationDrawerProps) {
  return (
    <div>
