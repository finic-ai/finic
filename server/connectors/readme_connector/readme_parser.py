...
class ReadmeParser:
    ...
    def get_docs_for_category(self, slug: str) -> List[Dict]:
        url = f"https://dash.readme.com/api/v1/categories/{slug}/docs?perPage=100&page=1"

        response = requests.get(url, auth=(self.api_key, ""), headers={"Accept": "application/json"})
        ...
        for doc_metadata in doc_metadatas:
            ...
            doc_response = requests.get(doc_url, auth=(self.api_key, ""), headers={"Accept": "application/json"})
