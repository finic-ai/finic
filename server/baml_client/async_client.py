...
class BamlStreamClient:
    ...
    def GenerateSelectors(
        ...
        selectors: List[types.Selector],html: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[List[partial_types.GenerateSelectorResult], List[types.GenerateSelectorResult]]:
      __tb__ = baml_options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb
      else:
      ...
      return baml_py.BamlStream[List[partial_types.GenerateSelectorResult], List[types.GenerateSelectorResult]](
        raw,
