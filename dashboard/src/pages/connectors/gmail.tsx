...
const GmailConnectorPage: FC = function () {
        ...
        <div className="mb-1 w-full">
          <div className="mb-4">
            <Breadcrumb className="mb-4">
              ...
              <Breadcrumb.Item>Gmail</Breadcrumb.Item>
            </Breadcrumb>
            ...
            <Text>
              View your active connections and configure the Gmail connector
    ...
    <>
      ...
      <div className="mb-4">
        <Text>
          ...
          <a
            href="https://docs.psychic.dev/connectors/gmail#configuration"
...
export default GmailConnectorPage;
