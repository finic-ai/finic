            ...
            <div className="flex-col items-center space-y-6">
              ...
              <div>
                <h2 className="mb-4 text-xl font-semibold text-gray-900 dark:text-white">
                    Step 2: Load documents from your test data source and ask it questions
                </h2>
                ...
                <Tabs.Group style="underline">
                    <Tabs.Item active title="Using LangChain">
                        <div className="flex-col space-y-4">
                            <Text>This Repl shows how to use Psychic's <a className="text-blue-400" href="https://docs.psychic.dev/python-sdk">Python SDK</a> with LangChain to ask questions over data you just connected.</Text>
                            <Text>It may take up to 60 seconds to load when running it for the first time.</Text>
                    ...
                    <Tabs.Item active title="Using the API">
                        <div className="flex-col space-y-4">
                            <Text>This Repl shows how to use Psychic's <a className="text-blue-400" href="https://docs.psychic.dev/api-reference/endpoint/ask-question">API</a> to ask questions over data you just connected.</Text>
                            <Text>The "/ask-question" endpoint is meant for POCs and should not be used in production applications. To use Psychic in production, use the <a className="text-blue-400" href="https://docs.psychic.dev/python-sdk">Python SDK</a> or the <a className="text-blue-400" href="https://docs.psychic.dev/api-reference/endpoint/get-documents">Get Documents </a>endpoint to retrieve documents and load them into a vector database.</Text>
                            <span className="flex flex-row items-center space-x-2">
                                <Text>To view the source code, click</Text>
                                <img className="h-8" src={replitShowFiles} />
                                <Text>below.</Text>
              ...
              <div>
                ...
                <Text><a className="text-blue-400" href="https://docs.psychic.dev/psychic-link">Psychic Link</a> can be added to any React application to let your users connect their own data sources.</Text>
                <Text className="mb-4">You can load these documents and use them with LangChain just like you did with your own documents.</Text>
  ...
  return (
    <button onClick={() => {
      ...
      Connect
              ...
              <div>
                <Button className="w-full md:w-1/5" href="/create-connection">✨ Finish</Button>
              </div>
            </div>
          </div>
        </div>
