...
const FinishSetupPage: FC = function () {
  ...
  async function authorize() {
    ...
    const url =
      "https://sidekick-server-ezml2kwdva-uc.a.run.app/authorize-google-drive";
    var payload = {
      auth_code: authCode,
  ...
  async function connectGoogleDrive() {
    ...
    try {
      ...
      const url =
        "https://sidekick-server-ezml2kwdva-uc.a.run.app/upsert-google-docs";
      var payload = {
            ...
            <form>
              <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
                ...
                <div className="lg:col-span-2">
                  ...
                  {upsertedChunks.length > 0 ? (
                    <p>{`Successfully upserted ${upsertedChunks.length} chunks`}</p>
                  ) : null}
                </div>
              </div>
            </form>
